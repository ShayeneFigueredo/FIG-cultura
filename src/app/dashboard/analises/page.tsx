    ...
    <div className="flex-1 min-w-0 flex flex-col min-h-0">
      <header className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8 px-6 lg:px-12">
        ...
        <div className="flex gap-4">
          ...
          <Link href="/dashboard/analises/novo" className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-brand-main hover:bg-brand-light text-white font-semibold transition-all shadow-md">
      ...
      {analyses.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center border-2 border-slate-200 border-dashed rounded-3xl mx-6 lg:mx-12 p-12 bg-white shadow-sm">
          <Database className="w-16 h-16 text-slate-300 mb-4" />
          <h2 className="text-xl font-bold text-slate-900 mb-2">Nenhuma análise encontrada</h2>
          <p className="text-slate-600 font-medium mb-6 max-w-md text-center">
            Comece inserindo os dados da sua primeira análise de solo para gerar diagnósticos e planejamento.
          </p>
          <Link href="/dashboard/analises/novo" className="px-6 py-3 rounded-xl bg-brand-main hover:bg-brand-light text-white font-semibold transition-all shadow-md">
