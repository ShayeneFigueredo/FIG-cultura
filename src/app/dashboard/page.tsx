  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 p-8 rounded-3xl relative overflow-hidden group">
          ...
          <h3 className="text-2xl font-medium mb-4 relative z-10 text-black dark:text-white">Gestão de Áreas</h3>
          <p className="text-black/60 dark:text-white/60 mb-8 relative z-10">Cadastre e gerencie propriedades e talhões para seus clientes.</p>
        ...
        <div className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 p-8 rounded-3xl relative overflow-hidden group">
          ...
          <h3 className="text-2xl font-medium mb-4 relative z-10 text-black dark:text-white">Análise de Solo</h3>
          <p className="text-black/60 dark:text-white/60 mb-8 relative z-10">Insira resultados laboratoriais e gere recomendações precisas.</p>
        ...
        <div className="bg-brand-main/5 dark:bg-white/5 border border-brand-main/30 p-8 rounded-3xl relative overflow-hidden group shadow-[0_0_15px_rgba(107,175,58,0.1)] md:col-span-2">
          ...
          <p className="text-black/60 dark:text-white/60 mb-8 relative z-10 max-w-2xl">
